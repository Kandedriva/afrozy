...
const StoreRefunds: React.FC = () => {
  ...
  const fetchRefunds = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.get('/refunds/store-owner/all', { params });
  ...
  const handleProcessRefund = async () => {
    ...
    setError(null);
    try {
      await axios.post(`/refunds/store-owner/${selectedRefund.id}/process`, {
  ...
  const handleCancelRefund = async () => {
    ...
    setError(null);
    try {
      await axios.post(`/refunds/store-owner/${selectedRefund.id}/cancel`, {
